...
public class EventMember implements Serializable{
    ...
    public EventMember(StringProperty name, StringProperty email, StringProperty password, StringProperty phoneNumber, StringProperty gender, StringProperty nidNo, int id, LocalDate birthday) {
        this.name = name;
        this.email = email;
